...
const Login = () => {
  ...
  const loginModes = {
    ...
    caregiver: {
      ...
      description: "Manage your caregiver profile, requests, and availability.",
      buttonText: "Continue as Caregiver",
      emailPlaceholder: "Enter your caregiver email",
      passwordPlaceholder: "Enter your caregiver password",
    },
    admin: {
      label: "Admin Login",
  ...
  const handleGoogleLogin = async () => {
    ...
    if (loginRole === "caregiver") {
      setErrorMessage("Caregiver login uses email and password only.");
      return;
    }
          ...
          <div className="w-full max-w-md">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-xl sm:p-10">
              ...
              <div className="mb-6 rounded-2xl border border-[#ff6fae]/15 bg-[#ff6fae]/5 p-4">
                ...
                {(isAdminMode || loginRole === "caregiver") && (
                  <p className="mt-2 text-xs font-medium text-amber-700">
                    {isAdminMode
                      ? "Admin access uses credentials only."
                      : "Caregiver access uses credentials only."}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={isAdminMode || loginRole === "caregiver"}
