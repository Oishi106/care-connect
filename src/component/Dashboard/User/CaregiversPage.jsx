...
const caregivers = [
  { id: 1, name: "Tanvir Hossain", specialty: "Elderly Care", rating: 4.9, reviews: 45, price: "$15/hr", image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=300&auto=format&fit=crop&q=60", available: true, badge: "Top Rated", exp: "5 years", languages: ["Bengali", "English"] },
  { id: 2, name: "Maya Islam", specialty: "Baby Sitting", rating: 4.8, reviews: 38, price: "$12/hr", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&auto=format&fit=crop&q=60", available: true, badge: "Verified", exp: "3 years", languages: ["Bengali", "English"] },
  { id: 3, name: "Sophie Rahman", specialty: "Patient Care", rating: 4.9, reviews: 52, price: "$18/hr", image: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=300&auto=format&fit=crop&q=60", available: false, badge: "Senior", exp: "7 years", languages: ["Bengali", "English", "Hindi"] },
  { id: 4, name: "Ethan Karim", specialty: "Special Needs", rating: 4.7, reviews: 29, price: "$20/hr", image: "https://images.unsplash.com/photo-1592334873219-42ca023e48ce?w=300&auto=format&fit=crop&q=60", available: true, badge: "Expert", exp: "4 years", languages: ["Bengali", "English"] },
  { id: 5, name: "Farhana Akter", specialty: "Elderly Care", rating: 4.8, reviews: 41, price: "$14/hr", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&auto=format&fit=crop&q=60", available: true, badge: "Popular", exp: "6 years", languages: ["Bengali"] },
  { id: 6, name: "Arif Chowdhury", specialty: "Patient Care", rating: 4.6, reviews: 22, price: "$16/hr", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&auto=format&fit=crop&q=60", available: true, badge: "Verified", exp: "2 years", languages: ["Bengali", "English"] },
];
